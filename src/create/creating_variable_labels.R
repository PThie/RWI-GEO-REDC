        ...
        label_data <- label_data |>
            dplyr::mutate(
                ...
                label = dplyr::case_when(
                    variable == "ajahr" ~ "Beginning of offer (year)",
                    ...
                    variable == "divisible_from" ~ "Divisible from",
                    variable == "dupID_gen" ~ "Classification of duplicates (RWI)",
                    variable == "duplicateid" ~ "Relating obid (ImmoScout)",
                    ...
                    variable == "heating_type" ~ "Classification of heating type",
                    ...
                    variable == "last_modernization" ~ "Last modernization",
                    ...
                    variable == "property_type" ~ "Classification of property type",
                    ...
                    grepl("bef", variable) ~ "Indicator for heating",
